...
Plugin genérico para OJS 3.5 que publica metadados da revista em formato ReDIF para indexação no RePEc.

Use o ramo `stable-3_5_0` para OJS 3.5. Use o ramo `stable-3_4_0` para OJS 3.4 e o ramo `stable-3_3_0` para OJS 3.3.
